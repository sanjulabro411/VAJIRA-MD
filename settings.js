...
global.owner = process.env.OWNER_NUMBER  || '94702866541' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7JlkTDDD#Xds4xIb2iWRNJqmXkl87rLgqD5CXEx-xPabL0zwPxCI' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94710513877,94776928548" : process.env.MODERATORS ,    
